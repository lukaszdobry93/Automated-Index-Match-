Attribute VB_Name = "Index_match_oparte_o_komorki"
Sub Makro_widoczne_formuly_komorki()
...
ay_address = ActiveCell.Offset(0, -1).Address
...
End If
    ...
    ax_address = ActiveCell.End(xlUp).Address
    ...
    ax_address = ActiveCell.Offset(-1, 0).End(xlUp).Address
    ...
    ActiveCell.Value = _
        "=INDEX(" & tbl_address & ", MATCH(" & ay_address & ", " & match_ay_range_address & ", 0), MATCH(" & ax_address & ", " & match_ax_range_address & ", 0))"
